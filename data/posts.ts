...
시부야스카이는 시부야역에 바로 연결된 시부야 스크램블 스퀘어 옥상 전망대입니다. 도쿄 전망대 중에서도 야외 루프탑에서 360도 파노라마를 즐길 수 있는 몇 안 되는 곳으로, 도쿄 여행에서 빠지면 아쉬운 코스입니다.
...
- **2주 전 자정**에 알람 필수 — 야경 티켓은 몇 분 안에 매진
...
`,
    ...
    images: [
      ...
      { src: "/images/posts/sibuya-sky-2.jpg", alt: { en: "Shibuya Sky ticket booking", ko: "시부야스카이 예약 화면" } },
