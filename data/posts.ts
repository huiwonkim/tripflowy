...
`,
  ...
  {
    slug: "tokyo-shibuya-sky-guide",
    courseId: "tokyo-shibuya-harajuku",
    title: {
      en: "Shibuya Sky Guide — Tickets, Night View & Rooftop Tips (2026)",
      ko: "시부야스카이 완벽 가이드 — 예약 꿀팁, 야경, 전망 비교 (2026)",
    },
    excerpt: {
      en: "Shibuya Sky tickets, best time for night views, and real tips from 3+ visits. How to book the Tokyo rooftop that sells out in minutes.",
      ko: "시부야스카이 예약법, 야경 시간대, 낮 vs 밤 비교까지. 3번 이상 다녀온 후기와 꿀팁 총정리.",
    },
    content: {
      en: `## Shibuya Sky — Tokyo's Only Outdoor Rooftop Observatory
...
![Shibuya Scramble Square entrance](0)
...
![Escalator ride up to Shibuya Sky rooftop](1)
...
![Tokyo Tower and Skytree panoramic view](3)
...
![Tokyo Tower night view from Shibuya Sky](7)
...
전망대 입구는 시부야 스크램블 스퀘어 14층에 있어요. 건물 바깥에 직행 엘리베이터가 있어서 바로 올라갈 수 있고, 시부야역 B6 출구에서 스크램블 교차로 방향으로 걸어가면 금방 보입니다. JR 시부야역과 직접 연결되어 있으니 비 오는 날도 걱정 없어요.

일찍 도착했다면 11층 스타벅스와 츠타야 서점을 둘러보세요. 12~13층에 식당도 꽤 있어서 전망대 전에 식사하기 좋습니다.
...
![도쿄타워·스카이트리 방향 파노라마](3)

루프탑 음료 카운터에서 칵테일, 맥주, 소프트드링크를 살 수 있어요. 저녁 시간 소파 구역은 여기서 음료 구매가 필수입니다.
...
기념품 숍에는 시부야스카이 한정 아이템이 있어요. 내려가는 길에 한 번 둘러볼 만합니다.
...
`,
    ...
    city: "tokyo",
    coverImage: "/images/posts/sibuya-sky-7.jpg",
    coverGradient: "from-indigo-500 to-purple-700",
    images: [
      // 0 — 가는 법: 건물 입구
      { src: "/images/posts/sibuya-sky-2.jpg", alt: { en: "Shibuya Scramble Square entrance", ko: "시부야 스크램블 스퀘어 입구" } },
      // 1 — 루프탑 진입: 에스컬레이터
      { src: "/images/posts/sibuya-sky-8.jpg", alt: { en: "Escalator ride up to Shibuya Sky rooftop with city view", ko: "시부야스카이 에스컬레이터에서 보는 도시 전망" } },
      // 2 — 루프탑 전체 모습
      { src: "/images/posts/sibuya-sky-5.jpg", alt: { en: "Shibuya Sky rooftop deck SKY STAGE with visitors", ko: "시부야스카이 루프탑 SKY STAGE 전경" } },
      // 3 — 도쿄타워 방향 파노라마 (낮)
      { src: "/images/posts/sibuya-sky-12.jpg", alt: { en: "Tokyo Tower and Skytree panoramic view from Shibuya Sky", ko: "시부야스카이에서 본 도쿄타워·스카이트리 방향 파노라마" } },
      // 4 — 실내 전망대 (45F)
      { src: "/images/posts/sibuya-sky-10.jpg", alt: { en: "Shibuya Sky 45F indoor observatory with National Stadium view", ko: "시부야스카이 45층 실내 전망대에서 본 신국립경기장" } },
      // 5 — 음료 카운터
      { src: "/images/posts/sibuya-sky-13.jpg", alt: { en: "Shibuya Sky rooftop bar and drink counter", ko: "시부야스카이 루프탑 바 음료 카운터" } },
      // 6 — 기념품 숍
      { src: "/images/posts/sibuya-sky-14.jpg", alt: { en: "Shibuya Sky gift shop on 45th floor", ko: "시부야스카이 45층 기념품 숍" } },
      // 7 — 야경 (도쿄타워)
      { src: "/images/posts/sibuya-sky-15.jpg", alt: { en: "Tokyo Tower night view from Shibuya Sky observatory", ko: "시부야스카이에서 본 도쿄타워 야경" } },
    ],
...
`,
    ...
    faq: [
      { question: { en: "How much are Tokyo Disneyland tickets?", ko: "도쿄 디즈니랜드 입장료는 얼마인가요?" }, answer: { en: "About $60–65 on Klook, or ¥9,400 on the official site (2026). Prices vary by date — weekends and peak days cost more.", ko: "클룩 기준 85,000~90,000원, 공식 홈페이지 9,400엔입니다 (2026년 기준). 날짜별로 가격이 다르고, 주말/성수기가 더 비싸요." } },
  ...
  },
  {
    ...
    title: {
      en: "Tokyo DisneySea Guide — Tickets, DPA, Fantasy Springs & Show Tips (2026)",
      ko: "도쿄 디즈니씨 가이드 — 티켓, DPA, 판타지 스프링스, 공연 꿀팁 (2026)",
    },
    excerpt: {
      en: "Tokyo DisneySea tickets, DPA vs Priority Pass, Fantasy Springs rides, and Believe! show tips from multiple visits to Japan's most unique Disney park.",
      ko: "도쿄 디즈니씨 티켓 예약, DPA·프라이어티 패스, 판타지 스프링스, 빌리브 공연 명당까지. 여러 번 다녀온 후기 총정리.",
    },
    content: {
      ko: `## 도쿄 디즈니씨 — 디즈니랜드와 전혀 다른 파크
...
오픈런을 하려면 ==오전 7~8시에는 도착==하는 게 좋습니다. 공식 개장 9시인데 보통 8시 30분쯤 입장 시작. 그래도 이미 엄청난 인파가 있습니다. 오픈런이 중요한 이유는 DPA와 프라이어티 패스를 빨리 잡기 위해서예요.
...
클룩에서 사면 바우처를 디즈니 앱에 등록해서 바로 입장 가능합니다. 인기 있는 날은 매진되니 ==일정 확정되면 바로 예매==하세요.

{{cta}}

![디즈니 앱 대기시간 화면](2)

입장권만 사면 놀이기구 무료. 추가 비용은 DPA(유료 익스프레스)뿐입니다. 운영 시간과 공연 스케줄은 [도쿄 디즈니리조트 공식 사이트](https://www.tokyodisneyresort.jp/kr/tds/)에서도 확인 가능합니다.
...
초기에는 별도 티켓이 있어야 입장 가능했지만, ==현재는 자유 입장==입니다. 다만 어트랙션 대기가 파크 내에서 가장 길어요 — 프로즌 저니 기준 일반 대기 2~3시간이 흔합니다.
...
- 빌리브 공연 명당은 **1시간 전**에 입구 왼쪽, DPA석 뒤
...
![DisneySea lake and volcano view](1)
...
![Disney Resort monorail station](0)
...
![Disney app showing wait times](2)

Entry ticket covers all rides for free. The only extra cost is DPA (paid express). Check hours and show schedules on the [official Tokyo Disney Resort site](https://www.tokyodisneyresort.jp/en/tds/).
...
![Believe! Sea of Dreams night show](7)
...
![DisneySea gift shop with plushies](6)
...
`,
    ...
    city: "tokyo",
    coverImage: "/images/posts/Tokyo-Disnesysea-4.jpg",
    coverGradient: "from-blue-500 to-teal-600",
    images: [
      // 0 — 모노레일역
      { src: "/images/posts/Tokyo-Disnesysea-8.jpg", alt: { en: "Disney Resort monorail station with Mickey Mouse gates", ko: "디즈니 리조트 모노레일역 미키마우스 게이트" } },
      // 1 — 호수+화산 전경
      { src: "/images/posts/Tokyo-Disnesysea-4.jpg", alt: { en: "Tokyo DisneySea lake and volcano panoramic view", ko: "도쿄 디즈니씨 호수와 화산 전경" } },
      // 2 — 앱 대기시간
      { src: "/images/posts/Tokyo-Disnesysea-2.jpg", alt: { en: "Tokyo Disney Resort app showing DisneySea ride wait times", ko: "디즈니 리조트 앱 디즈니씨 대기시간 화면" } },
      // 3 — 타워 오브 테러
      { src: "/images/posts/Tokyo-Disnesysea-5.jpg", alt: { en: "Tower of Terror building at Tokyo DisneySea", ko: "도쿄 디즈니씨 타워 오브 테러 외관" } },
      // 4 — 판타지 스프링스
      { src: "/images/posts/Tokyo-Disnesysea-7.jpg", alt: { en: "Fantasy Springs entrance at Tokyo DisneySea", ko: "도쿄 디즈니씨 판타지 스프링스 입구" } },
      // 5 — 아쿠아토피아 구역
      { src: "/images/posts/Tokyo-Disnesysea-6.jpg", alt: { en: "Aquatopia ride area at Tokyo DisneySea", ko: "도쿄 디즈니씨 아쿠아토피아 구역" } },
      // 6 — 기념품
      { src: "/images/posts/Tokyo-Disnesysea-3.jpg", alt: { en: "Tokyo DisneySea gift shop with character plushies", ko: "도쿄 디즈니씨 기념품 숍 캐릭터 인형" } },
      // 7 — 빌리브 야간 공연
      { src: "/images/posts/Tokyo-Disnesysea-1.jpg", alt: { en: "Believe! Sea of Dreams night show at Tokyo DisneySea", ko: "도쿄 디즈니씨 빌리브 씨 오브 드림스 야간 공연" } },
    ],
    tags: ["guide", "complete-guide", "theme-park", "disney", "disneysea", "booking-tips"],
    categories: ["sightseeing", "complete-guide", "booking", "tips"],
    faq: [
      { question: { en: "How much are Tokyo DisneySea tickets?", ko: "도쿄 디즈니씨 입장료는 얼마인가요?" }, answer: { en: "About $60–65 on Klook, or ¥9,400 on the official site (2026). Same price as Disneyland. Varies by date.", ko: "클룩 기준 85,000~90,000원, 공식 홈페이지 9,400엔입니다 (2026년 기준). 디즈니랜드와 동일 가격이고, 날짜별로 변동됩니다." } },
      { question: { en: "Do I need a separate ticket for Fantasy Springs?", ko: "판타지 스프링스 별도 티켓이 필요한가요?" }, answer: { en: "Not anymore. Entry to Fantasy Springs is now free. However, ride wait times are the longest in the park — expect 2–3 hours for Frozen Journey without DPA.", ko: "지금은 필요 없습니다. 자유 입장이에요. 다만 어트랙션 대기는 파크 내 가장 길어서 프로즌 저니 기준 DPA 없으면 2~3시간 기다려야 합니다." } },
