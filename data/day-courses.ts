...
export const dayCourses: DayCourse[] = [
  ...
  },
  {
    ...
    whyThisCourse: [
      { en: "Conquer Da Nang's top theme park Ba Na Hills in one day", ko: "다낭 대표 테마파크 바나힐을 하루에 정복" },
      { en: "Optimized route: Golden Bridge + Cable Car + French Village", ko: "골든브릿지 + 케이블카 + 프렌치빌리지까지 동선 최적화" },
      { en: "Budget-friendly Four Seasons buffet lunch included", ko: "포시즌스 뷔페로 가성비 점심 해결" },
    ...
    activities: [
      {
        ...
        type: "transport", location: { lat: 16.0670, lng: 108.2232 },
      },
      {
        ...
        type: "sightseeing", location: { lat: 16.0265, lng: 108.0328 },
      ...
      },
      {
        ...
        type: "sightseeing", location: { lat: 15.9951, lng: 107.9961 },
      ...
      },
      {
        ...
        type: "dining", location: { lat: 16.0635, lng: 108.2232 },
        duration: 60,
      },
      {
    ...
    center: { lat: 16.0380, lng: 108.0688 },
    ...
    googleMapsUrl: "https://www.google.com/maps/d/u/0/edit?mid=1ZqnDm9o7UjhM615EZkyWsa2RjvBhjJo&usp=sharing",
  },
  {
  ...
  { id: "nhatrang-diving", city: "nhatrang", title: { en: "Scuba Diving Adventure", ko: "스쿠버 다이빙 체험" }, summary: { en: "Beginner-friendly diving at Hon Mun marine reserve.", ko: "혼문 해양보호구역에서 초보자 다이빙." }, styles: ["activity"], travelerTypes: ["solo", "couple", "friends"], activities: [
  ...
  // ════════════════════════════════════════════════════
  { id: "chiangmai-old-city-temples", city: "chiangmai", title: { en: "Old City Temples Walk", ko: "올드시티 사원 산책" }, summary: { en: "Explore Chiang Mai's most beautiful temples within the old city walls.", ko: "올드시티 성벽 안의 아름다운 사원 탐방." }, styles: ["relax", "efficient"], travelerTypes: ["solo", "couple", "friends"], activities: [
  ...
  { id: "chiangmai-sunday-night-market", city: "chiangmai", title: { en: "Sunday Night Market (Walking Street)", ko: "일요 야시장 (워킹 스트리트)" }, summary: { en: "Chiang Mai's best market — street food, crafts, and live music.", ko: "치앙마이 최고 시장 — 길거리 음식, 공예품, 라이브 음악." }, styles: ["relax", "efficient"], travelerTypes: ["solo", "couple", "friends"], activities: [
  ...
  { id: "chiangmai-cooking-class", city: "chiangmai", title: { en: "Thai Cooking Class & Market Tour", ko: "태국 요리 수업 & 시장 투어" }, summary: { en: "Morning market visit, then cook 5 Thai dishes with a local chef.", ko: "아침 시장 방문 후 현지 셰프와 5가지 태국 요리." }, styles: ["relax", "activity"], travelerTypes: ["couple", "solo", "friends"], activities: [
  ...
  // PHUKET (5 courses)
  // ════════════════════════════════════════════════════
  { id: "phuket-old-town-cape", city: "phuket", title: { en: "Old Town & Promthep Cape", ko: "올드타운 & 프롬텝 곶" }, summary: { en: "Sino-Portuguese architecture, then Phuket's best sunset viewpoint.", ko: "시노포르투갈 건축물, 푸켓 최고 선셋 포인트." }, styles: ["efficient", "relax"], travelerTypes: ["couple", "solo"], activities: [
  ...
  { id: "phuket-phi-phi-island", city: "phuket", title: { en: "Phi Phi Island Day Trip", ko: "피피 섬 당일 투어" }, summary: { en: "Speed boat to Maya Bay, snorkeling, and Phi Phi viewpoint.", ko: "마야 베이 스피드보트, 스노클링, 피피 전망대." }, styles: ["activity"], travelerTypes: ["couple", "friends"], activities: [
  ...
  { id: "phuket-patong-beach", city: "phuket", title: { en: "Patong Beach & Bangla Road", ko: "파통 해변 & 방라 로드" }, summary: { en: "Phuket's busiest beach by day, Bangla Road nightlife by night.", ko: "낮에는 파통 해변, 밤에는 방라 로드 나이트라이프." }, styles: ["relax", "activity"], travelerTypes: ["solo", "friends"], activities: [
  ...
  // TOKYO (6 courses)
  // ════════════════════════════════════════════════════
  { id: "tokyo-shibuya-harajuku", city: "tokyo", title: { en: "Shibuya & Harajuku", ko: "시부야 & 하라주쿠" }, summary: { en: "Iconic crossing, Meiji Shrine, and Takeshita Street fashion.", ko: "상징적인 스크램블, 메이지 신궁, 다케시타 거리 패션." }, styles: ["efficient", "activity"], travelerTypes: ["solo", "friends"], activities: [
  ...
  { id: "tokyo-shinjuku-golden-gai", city: "tokyo", title: { en: "Shinjuku & Golden Gai", ko: "신주쿠 & 골든 가이" }, summary: { en: "Department stores, Gyoen garden, and tiny bar alleyways.", ko: "백화점, 교엔 정원, 작은 바 골목." }, styles: ["relax", "efficient"], travelerTypes: ["solo", "couple", "friends"], activities: [
  ...
  { id: "osaka-namba-amerikamura", city: "osaka", title: { en: "Namba & Amerikamura", ko: "난바 & 아메리카무라" }, summary: { en: "Youth culture, vintage shops, and street style.", ko: "청소년 문화, 빈티지 숍, 스트리트 스타일." }, styles: ["relax", "activity"], travelerTypes: ["solo", "friends"], activities: [
  ...
  { id: "kyoto-fushimi-gion", city: "kyoto", title: { en: "Fushimi Inari & Gion Geisha District", ko: "후시미 이나리 & 기온 게이샤 지구" }, summary: { en: "Thousand red gates and Kyoto's famous geisha quarter.", ko: "천 개의 빨간 도리이와 교토 게이샤 거리." }, styles: ["efficient", "activity"], travelerTypes: ["solo", "couple", "friends"], activities: [
  ...
  { id: "kyoto-tea-ceremony-zen", city: "kyoto", title: { en: "Zen Gardens & Tea Ceremony", ko: "선 정원 & 다도 체험" }, summary: { en: "Ryoan-ji rock garden, Zen meditation, and matcha tea.", ko: "료안지 돌 정원, 선 명상, 말차 다도." }, styles: ["relax"], travelerTypes: ["couple", "solo"], activities: [
  ...
  { id: "kyoto-higashiyama-pottery", city: "kyoto", title: { en: "Higashiyama & Pottery Street", ko: "히가시야마 & 도자기 거리" }, summary: { en: "Stone-paved streets, traditional shops, and Kiyomizu pottery.", ko: "돌길, 전통 가게, 기요미즈 도자기." }, styles: ["relax", "efficient"], travelerTypes: ["couple", "solo"], activities: [
  ...
  // FUKUOKA (3 courses)
  // ════════════════════════════════════════════════════
  { id: "fukuoka-yatai-canal", city: "fukuoka", title: { en: "Yatai Street Stalls & Canal City", ko: "야타이 포장마차 & 캐널시티" }, summary: { en: "Fukuoka's legendary ramen stalls and riverside mall.", ko: "후쿠오카 전설의 라멘 포장마차와 하천 쇼핑몰." }, styles: ["efficient", "relax"], travelerTypes: ["solo", "couple", "friends"], activities: [
  ...
  { id: "paris-montmartre", city: "paris", title: { en: "Montmartre & Sacré-Cœur", ko: "몽마르트르 & 사크레쾨르" }, summary: { en: "Artist hill, Sacré-Cœur basilica, and street performers.", ko: "예술가의 언덕, 사크레쾨르 성당, 거리 공연." }, styles: ["relax"], travelerTypes: ["couple", "solo", "friends"], activities: [
  ...
  { id: "paris-latin-quarter-notredame", city: "paris", title: { en: "Latin Quarter & Notre-Dame", ko: "라탱 지구 & 노트르담" }, summary: { en: "Student quarter, Shakespeare & Co, and the famous cathedral.", ko: "학생 지구, 셰익스피어 앤 코, 유명 성당." }, styles: ["relax", "efficient"], travelerTypes: ["solo", "couple"], activities: [
  ...
  { id: "rome-trevi-spanish-steps", city: "rome", title: { en: "Trevi Fountain & Spanish Steps", ko: "트레비 분수 & 스페인 계단" }, summary: { en: "Baroque fountains, piazzas, and espresso in Rome's center.", ko: "바로크 분수, 광장, 로마 중심의 에스프레소." }, styles: ["relax"], travelerTypes: ["couple", "solo", "friends"], activities: [
  ...
  { id: "rome-borghese-aperitivo", city: "rome", title: { en: "Villa Borghese & Aperitivo", ko: "보르게세 공원 & 아페리티보" }, summary: { en: "Art gallery in the park, then Roman-style sunset drinks.", ko: "공원 속 갤러리, 로마식 선셋 드링크." }, styles: ["relax", "hotel"], travelerTypes: ["couple", "solo"], activities: [
  ...
  { id: "florence-ponte-vecchio-oltrarno", city: "florence", title: { en: "Ponte Vecchio & Oltrarno", ko: "베키오 다리 & 올트라르노" }, summary: { en: "Goldsmith bridge and artisan neighborhood across the Arno.", ko: "금세공 다리와 아르노강 건너 장인의 동네." }, styles: ["relax"], travelerTypes: ["couple", "solo"], activities: [
  ...
  { id: "florence-tuscan-wine", city: "florence", title: { en: "Tuscan Wine & Countryside", ko: "투스카니 와인 & 시골" }, summary: { en: "Half-day wine tasting in Chianti hills.", ko: "키안티 언덕에서 반나절 와인 테이스팅." }, styles: ["relax", "hotel"], travelerTypes: ["couple", "friends"], activities: [
  ...
  { id: "venice-burano-colors", city: "venice", title: { en: "Burano Colorful Island", ko: "부라노 알록달록 섬" }, summary: { en: "Most colorful island in Venice — lace, photos, and seafood.", ko: "베네치아에서 가장 알록달록한 섬 — 레이스, 사진, 해산물." }, styles: ["relax", "activity"], travelerTypes: ["couple", "friends", "solo"], activities: [
  ...
  { id: "london-tower-shoreditch", city: "london", title: { en: "Tower of London & Shoreditch", ko: "런던 타워 & 쇼디치" }, summary: { en: "Crown Jewels, Tower Bridge, then East London street art.", ko: "왕관 보석, 타워 브릿지, 이스트 런던 스트리트 아트." }, styles: ["efficient", "activity"], travelerTypes: ["solo", "friends"], activities: [
  ...
  { id: "london-notting-hill-hyde", city: "london", title: { en: "Notting Hill & Hyde Park", ko: "노팅힐 & 하이드 파크" }, summary: { en: "Pastel houses, Portobello Market, and London's great park.", ko: "파스텔 집, 포토벨로 마켓, 런던의 대공원." }, styles: ["relax"], travelerTypes: ["couple", "solo", "friends"], activities: [
  ...
  { id: "barcelona-park-guell-gracia", city: "barcelona", title: { en: "Park Güell & Gràcia", ko: "구엘 공원 & 그라시아" }, summary: { en: "Gaudí's colorful park and Barcelona's local neighborhood.", ko: "가우디의 알록달록 공원과 현지인 동네." }, styles: ["relax", "activity"], travelerTypes: ["couple", "friends", "solo"], activities: [
  ...
  { id: "barcelona-montjuic-flamenco", city: "barcelona", title: { en: "Montjuïc & Flamenco Night", ko: "몬주이크 & 플라멩코 나이트" }, summary: { en: "Castle, Olympic park, Magic Fountain, and live flamenco.", ko: "성, 올림픽 공원, 매직 분수, 라이브 플라멩코." }, styles: ["efficient", "activity"], travelerTypes: ["couple", "friends"], activities: [
  ...
  { id: "newyork-soho-chelsea", city: "newyork", title: { en: "SoHo, Chelsea & High Line", ko: "소호, 첼시 & 하이라인" }, summary: { en: "Cast-iron architecture, galleries, and elevated park.", ko: "주철 건축물, 갤러리, 공중 공원." }, styles: ["relax"], travelerTypes: ["couple", "solo", "friends"], activities: [
  ...
  { id: "newyork-harlem-museum-mile", city: "newyork", title: { en: "Museum Mile & Harlem", ko: "뮤지엄 마일 & 할렘" }, summary: { en: "Met Museum, Guggenheim, and Harlem soul food.", ko: "메트 뮤지엄, 구겐하임, 할렘 소울 푸드." }, styles: ["efficient", "relax"], travelerTypes: ["solo", "couple"], activities: [
  ...
  { id: "istanbul-spice-bazaar-galata", city: "istanbul", title: { en: "Spice Bazaar & Galata Tower", ko: "스파이스 바자르 & 갈라타 타워" }, summary: { en: "Aromatic spice market, Galata views, and Istiklal Avenue.", ko: "향신료 시장, 갈라타 전망, 이스티클랄 거리." }, styles: ["efficient", "relax"], travelerTypes: ["solo", "friends"], activities: [
  ...
  { id: "istanbul-topkapi-hammam", city: "istanbul", title: { en: "Topkapi Palace & Turkish Hammam", ko: "톱카프 궁전 & 터키 하맘" }, summary: { en: "Ottoman sultan's palace, then a traditional bath experience.", ko: "오스만 술탄의 궁전, 전통 목욕 체험." }, styles: ["efficient", "relax"], travelerTypes: ["couple", "solo"], activities: [
  ...
  { id: "cappadocia-balloon-valleys", city: "cappadocia", title: { en: "Hot Air Balloon & Fairy Chimneys", ko: "열기구 & 요정 굴뚝" }, summary: { en: "Sunrise balloon flight over fairy chimneys and cave valleys.", ko: "요정 굴뚝과 동굴 계곡 위로 선라이즈 열기구 비행." }, styles: ["activity", "relax"], travelerTypes: ["couple", "friends"], activities: [
  ...
  { id: "cappadocia-underground-city", city: "cappadocia", title: { en: "Underground City & Ihlara Valley", ko: "지하도시 & 이흘라라 계곡" }, summary: { en: "8-story underground city and a canyon hike.", ko: "8층 지하도시와 협곡 하이킹." }, styles: ["activity", "efficient"], travelerTypes: ["solo", "friends", "couple"], activities: [
  ...
  { id: "cappadocia-sunset-horseback", city: "cappadocia", title: { en: "Sunset Horse Ride & Cave Hotel", ko: "선셋 승마 & 동굴 호텔" }, summary: { en: "Horseback ride through valleys at sunset, then cave hotel.", ko: "선셋 계곡 승마, 동굴 호텔 체험." }, styles: ["relax", "hotel"], travelerTypes: ["couple"], activities: [
  ...
  { id: "antalya-aspendos-perge", city: "antalya", title: { en: "Aspendos & Perge Ancient Cities", ko: "아스펜도스 & 페르게 고대 도시" }, summary: { en: "Best-preserved Roman theater and ancient Pamphylian city.", ko: "가장 잘 보존된 로마 극장과 고대 팜필리아 도시." }, styles: ["efficient", "activity"], travelerTypes: ["solo", "couple", "friends"], activities: [
  ...
  { id: "la-venice-malibu", city: "la", title: { en: "Venice Beach & Malibu", ko: "베니스 비치 & 말리부" }, summary: { en: "Boardwalk, Muscle Beach, Abbot Kinney, and Malibu coast.", ko: "보드워크, 머슬 비치, 애봇 키니, 말리부 해안." }, styles: ["relax", "activity"], travelerTypes: ["solo", "friends", "couple"], activities: [
  ...
  // LAS VEGAS (3 courses)
  { id: "lasvegas-strip-shows", city: "lasvegas", title: { en: "The Strip & Shows", ko: "스트립 & 쇼" }, summary: { en: "Bellagio fountains, casino walk, and a live show.", ko: "벨라지오 분수, 카지노 산책, 라이브 쇼." }, styles: ["efficient", "activity"], travelerTypes: ["couple", "friends"], activities: [
  ...
  { id: "lasvegas-fremont-downtown", city: "lasvegas", title: { en: "Fremont Street & Downtown", ko: "프리몬트 스트리트 & 다운타운" }, summary: { en: "Old Vegas neon, Fremont Experience, and craft cocktails.", ko: "올드 베가스 네온, 프리몬트 체험, 크래프트 칵테일." }, styles: ["relax", "efficient"], travelerTypes: ["solo", "friends", "couple"], activities: [
  ...
  { id: "seattle-capitol-hill-coffee", city: "seattle", title: { en: "Capitol Hill & Coffee Culture", ko: "캐피톨 힐 & 커피 문화" }, summary: { en: "Seattle's hippest neighborhood and its legendary coffee scene.", ko: "시애틀에서 가장 힙한 동네와 전설적인 커피 문화." }, styles: ["relax", "activity"], travelerTypes: ["solo", "friends"], activities: [
  ...
  { id: "boston-harvard-cambridge", city: "boston", title: { en: "Harvard & Cambridge", ko: "하버드 & 케임브리지" }, summary: { en: "Harvard campus, MIT, and Cambridge's bookshops and cafes.", ko: "하버드 캠퍼스, MIT, 케임브리지 서점과 카페." }, styles: ["relax", "efficient"], travelerTypes: ["solo", "couple", "friends"], activities: [
  ...
  { id: "shanghai-french-concession", city: "shanghai", title: { en: "French Concession & Tianzifang", ko: "프랑스 조계지 & 톈쯔팡" }, summary: { en: "Tree-lined boulevards, art deco villas, and creative lanes.", ko: "가로수 대로, 아르데코 빌라, 창의적 골목." }, styles: ["relax"], travelerTypes: ["couple", "solo", "friends"], activities: [
